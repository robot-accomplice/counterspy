...
func TestRunConsole_TabSwitchesModeAndLazySamples(t *testing.T) {
	...
	go func() { done <- RunConsole(s, m, &fakeActor{}, cs, nil, tick, nil, nil, "") }()
...
func TestRunConsole_FindingsQuarantineFlow(t *testing.T) {
	...
	go func() { done <- RunConsole(s, m, fa, fakeSampler{}, nil, tick, nil, nil, "") }()
...
func TestRunConsole_QuitWhileSampleBlocks(t *testing.T) {
	...
	go func() { done <- RunConsole(s, New(nil, nil), &fakeActor{}, bs, nil, make(chan struct{}), nil, nil, "") }()
...
func TestRunConsole_PausedSkipsResample(t *testing.T) {
	...
	go func() { done <- RunConsole(s, New(nil, nil), &fakeActor{}, cs, nil, tick, nil, nil, "") }()
